...
void R_SAU0_Create(void)
{
    ...
    NOP();
    NOP();
    SPS0 = _0003_SAU_CK00_FCLK_3 | _0000_SAU_CK01_FCLK_0;
    R_CSI01_Create();
    R_CSI10_Create();
}
...
void R_CSI01_Create(void)
{
    ...
    SCR01 = _C000_SAU_RECEPTION_TRANSMISSION | _0000_SAU_TIMING_1 | _0080_SAU_LSB | _0007_SAU_LENGTH_8;
